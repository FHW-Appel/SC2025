...
class realerkenner(basisstrat):
    ...
    def act(self, history_self, history_opponent):
        ...
        if roundcounter >= 0 and roundcounter < 6:
            ...
            if opponent == "self":
                return self.COOPERATE
            elif opponent == "erkenner" or opponent == "unknown" or opponent == "stupidniceman" or opponent == "dagoberte" or opponent == "nachtragend" or opponent == "Ping_Pong":
                return self.DEFECT
            else:
                return self.COOPERATE
